	...
	"NICKSERV": {
		{
			...
			Syntax: []string{"<username:string>", "[password:string]"},
		},
		{
			...
			Syntax: []string{"<password:string>", "[email:string]"},
		},
		...
		},
		{
			...
			Syntax: []string{"<username:string>", "[code:string]"},
		},
		{
		...
		},
		{
			...
			Syntax: []string{"<current:string>", "<new:string>", "<new_again:string>"},
		},
		{
		...
		},
		{
			...
			Syntax: []string{"<setting:string>", "<value:string>"},
		},
		{
		...
		{Name: "CERT", Desc: "Manage TLS certificate fingerprints\n" +
			...
			},
			{
				...
				Syntax: []string{"<fingerprint:string>"},
			},
			{
		...
		{Name: "CLIENTS", Desc: "List or logout sessions on your account\n" +
			...
			},
			{
				...
				Syntax: []string{"[nickname:nick]", "[client_id:string]"},
			},
		}},
		{Name: "SUSPEND", Desc: "Manage account suspensions\n" +
			...
			"command lists all current suspensions.", Subcommands: []Command{
			{
				...
				Syntax: []string{"<nickname:nick>", "[DURATION duration:string]", "[reason:string]"},
			},
			{
		...
		}},
		{
			...
			Syntax: []string{"<account:string>", "<newname:string>"},
		},
		{
		...
		}},
		{
			...
			Syntax: []string{"<account:string>", "<setting:string>"},
		},
		{
			Name: "SASET", Desc: "Modify another user's account settings\n" +
				...
				"information on the settings and their possible values, see HELP SET.",
			Syntax: []string{"<account:string>", "<setting:string>", "<value:string>"},
		},
		{
		...
		},
		{
			...
			Syntax: []string{"<account:string>", "<code:string>", "<password:string>"},
		},
	},
	"CHANSERV": {
		{
			...
			Syntax: []string{"<#channel:channel>", "[nickname:nick]"},
		},
		{
		...
		},
		{
			...
			Args:   []ArgType{ArgChannel},
			Syntax: []string{"<#channel:channel>", "[code:string]"},
		},
		{
		...
		},
		{
			Name: "GET", Desc: "Query channel settings\n" +
				...
				"on the settings and their possible values, see HELP SET.",
			Args:   []ArgType{ArgChannel},
			Syntax: []string{"<#channel:channel>", "<setting:string>"},
		},
		{
			...
			Args:   []ArgType{ArgChannel},
			Syntax: []string{"<#channel:channel>", "<setting:string>", "<value:string>"},
		},
		{
			...
			Args:   []ArgType{ArgChannel},
			Syntax: []string{"<#channel:channel>", "[mode:string]", "[account:string]"},
		},
		{
			...
			Args:   []ArgType{ArgChannel},
			Syntax: []string{"<#channel:channel>", "<target:string>"},
		},
		{
			...
			Args:   []ArgType{ArgChannel},
			Syntax: []string{"<#channel:channel>", "<user:string>", "[code:string]"},
		},
		{Name: "PURGE", Desc: "Blacklist a channel from the server\n" +
			...
			"PURGE DEL. To list purged channels, use PURGE LIST.", Subcommands: []Command{
			{
				...
				Syntax: []string{"<#channel:channel>", "[code:string]", "[reason:string]"},
			},
			{
		...
		},
		{
			...
			Args:   []ArgType{ArgChannel, ArgNick},
			Syntax: []string{"<#channel:channel>", "<nick:nick>"},
		},
	},
	"HOSTSERV": {
		...
		},
		{
			...
			Syntax: []string{"<secret:string>", "[code:string]"},
		},
	},
	"HISTSERV": {
		{
			...
			Syntax: []string{"<target:channel|nick>", "[limit:string]"},
		},
		{
			...
			Args:   []ArgType{ArgTarget},
			Syntax: []string{"<target:channel|nick>", "<msgid:string>"},
		},
		{
			...
			Args:   []ArgType{ArgTarget},
			Syntax: []string{"<account:channel|nick>"},
		},
		{
